...
<input type="file" name="profileImage" id="profileImage" accept=".jpg, .jpeg, .png, JPG, .JPEG, .BMP"/>
...
<script>
	...
	$("#profileForm").ajaxForm(function(responseData){
		...
		//savedPath라는 방에 저장된 이미지의 경로가 들어있다.
		console.log(responseData);
		var src="${pageContext.request.contextPath }"
		+responseData.savedPath;
		
		//img의 src 속성에 반영함으로서 이미지가 업데이트 되도록 한다.
